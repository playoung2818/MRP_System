...
def _reset_gsheet_user_format(ws) -> None:
    """
    Clear user-entered formatting for the worksheet grid so stale fills do not
    survive across refreshes. This keeps values/formulas clearing separate from
    visual formatting reset.
    """
    try:
        ws.batch_format(
            [
        ...
        # Formatting reset is best-effort; data write should still proceed.
        pass
